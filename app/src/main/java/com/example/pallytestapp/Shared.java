...
public class Shared extends AzureSpatialAnchorsActivity
{
    ...
    private static final String SharingAnchorsServiceUrl = "https://pallyanchorservice.azurewebsites.net/api/anchors";
    ...
    {
        setContentView(R.layout.anchor_activity_shared);
    }
