...
public class AzureSpatialAnchorsActivity extends AppCompatActivity
{
    ...
    private static final String SpatialAnchorsAccountId = "cec772fe-22df-4dd3-88ed-dcb53ae1c30b";

    // Set this string to the account key provided for the Azure Spatial Service resource.
    private static final String SpatialAnchorsAccountKey = "F0cxgPav0mrChXRA3YddEgOrb2ez21Beza+2hMwHCf0=";
    ...
    {
        setContentView(R.layout.anchor_activity_anchors);
    }
